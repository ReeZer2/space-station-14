...
public sealed partial class ShuttleNavControl : BaseShuttleControl
{
    ...
    private readonly SharedAdditionalShuttleControlSystem _additionalShuttle; // SS220 add additional control for shuttle
    ...
    private bool _isFiring; // SS220 add additional control for shuttle
    ...
    public ShuttleNavControl() : base(64f, 256f, 256f)
    {
        ...
        _additionalShuttle = EntManager.System<SharedAdditionalShuttleControlSystem>(); // SS220 add additional control for shuttle
    }
    ...
    protected override void Draw(DrawingHandleScreen handle)
    {
            ...
            EntManager.TryGetComponent<AdditionalShuttleControlComponent>(_consoleEntity, out var additionalShuttleControl))
        {
            ...
            {
                var viewPos = Vector2.Transform(additionalShuttleControl.LastRotateToPoint.Value.Position, worldToView);
            ...
            foreach (var gunRecord in additionalShuttleControl.ShuttleGunRecords)
            {
                ...
                if (!_additionalShuttle.CanShoot(entGun.Value, out var distance))
                    continue;
